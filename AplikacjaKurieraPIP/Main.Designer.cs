namespace AplikacjaKurieraPIP
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
			...
			this.takePackages.Controls.Add(this.button7);
			this.takePackages.Controls.Add(this.button6);
			this.takePackages.Controls.Add(this.button5);
			this.takePackages.Controls.Add(this.button4);
			this.takePackages.Controls.Add(this.button3);
			this.takePackages.Controls.Add(this.label7);
			this.takePackages.Controls.Add(this.label6);
			this.takePackages.Controls.Add(this.label5);
			this.takePackages.Controls.Add(this.label4);
			this.takePackages.Controls.Add(this.ordersTakenList);
			this.takePackages.Controls.Add(this.dbOrdersList);
			this.takePackages.Controls.Add(this.takenPackagesList);
			this.takePackages.Controls.Add(this.dbPackagesList);
			this.takePackages.Location = new System.Drawing.Point(287, 59);
			...
			this.gMapControl1.Location = new System.Drawing.Point(446, 27);
			...
			this.panel4.Location = new System.Drawing.Point(481, 263);
			...
			this.label16.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(233)))), ((int)(((byte)(196)))), ((int)(((byte)(106)))));
			this.label16.Location = new System.Drawing.Point(16, 38);
			this.label16.Name = "label16";
			this.label16.Size = new System.Drawing.Size(147, 25);
			this.label16.TabIndex = 8;
			this.label16.Text = "Wybierz powód";
			// 
			// button13
			// 
			this.button13.Location = new System.Drawing.Point(297, 72);
			...
			this.label17.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(233)))), ((int)(((byte)(196)))), ((int)(((byte)(106)))));
			this.label17.Location = new System.Drawing.Point(14, 2);
			...
			this.takePackages.ResumeLayout(false);
			this.takePackages.PerformLayout();
			this.packagesToDeliver.ResumeLayout(false);
        ...
        private System.Windows.Forms.Panel packageDetail;
        private System.Windows.Forms.Label label3;
        private System.Windows.Forms.Label label2;
        private System.Windows.Forms.Label workTimeLabel;
		private System.Windows.Forms.Label label4;
		private System.Windows.Forms.ListView ordersTakenList;
		private System.Windows.Forms.ListView dbOrdersList;
		private System.Windows.Forms.ListView takenPackagesList;
		private System.Windows.Forms.ListView dbPackagesList;
